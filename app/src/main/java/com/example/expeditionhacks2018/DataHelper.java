...
public class DataHelper {
    ...
    private static List<HealthSuggestion> sColorSuggestions =
            new ArrayList<>(Arrays.asList(
                    new HealthSuggestion("TradeUp"),
                    new HealthSuggestion("TradeDown"),
                    new HealthSuggestion("Serve"),
                    new HealthSuggestion("Pimp"),
                    new HealthSuggestion("Trap"),
                    new HealthSuggestion("Trick Roller"),
                    new HealthSuggestion("Backpage")));
