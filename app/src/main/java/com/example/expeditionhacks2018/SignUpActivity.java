...
public class SignUpActivity extends AppCompatActivity implements View.OnClickListener, AdapterView.OnItemSelectedListener  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mSceneSignUp.setEnterAction(new Runnable() {
            ...
            public void run() {
                ...
                loginView.setOnClickListener(SignUpActivity.this);
    ...
    public void onClick(final View view) {
        ...
        if(signUpOk) {
            ...
            mFrtContent.setBackgroundColor(ContextCompat.getColor(SignUpActivity.this, R.color.colorPrimaryDark));
...
//            });
                    ...
                    .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            ...
                            if(task.isSuccessful()){
                                ...
                                Toast.makeText(SignUpActivity.this, R.string.reg_success, Toast.LENGTH_LONG).show();
                                ...
                                snackbar.show();*/
                                Toast.makeText(SignUpActivity.this, "User already exists! Please go log in.", Toast.LENGTH_LONG).show();
    ...
    public void profileSetup() {
        ...
        //Toast.makeText(SignUpActivity.this,day + "/" + month + "/" + year, Toast.LENGTH_LONG).show();
